...
import type { LoginFormData, RegisterFormData, ForgotPasswordFormData, ResetPasswordFormData } from '../validation/auth.schemas.ts';
...
class AuthService {
  ...
  redirectAfterLogin(userRole: 'teacher' | 'student') {
  ...
  redirectAfterRegister(requiresEmailConfirmation: boolean = false) {
