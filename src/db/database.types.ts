  ...
  public: {
    Tables: {
      ...
      users: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_teacher_teacher_id"
            columns: ["teacher_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
    ...
    Enums: {
      date_status: "dostępny" | "zarezerwowany" | "anulowany"
      lesson_status: "zaplanowana" | "zakończona" | "anulowana"
      reservation_status: "potwierdzona" | "anulowana"
      user_role: "lektor" | "uczeń"
    }
    CompositeTypes: {
      [_ in never]: never
    }
