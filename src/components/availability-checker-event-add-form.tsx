...
export function AvailabilityCheckerEventAddForm({ start, end }: AvailabilityCheckerEventAddFormProps) {
  const { events, addEvent } = useEvents();
  const { availabilityCheckerEventAddOpen, setAvailabilityCheckerEventAddOpen } = useEvents();
